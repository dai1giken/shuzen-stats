...
''')
  ...
  <div class="warn">
    <h4>読むときの注意</h4>
    <ul>
      <li>このサイトの<a href="{SITE_URL}reform/">改修市場のページ</a>は<strong>建築物リフォーム・リニューアル調査</strong>で、「改修を<strong>いくら受注したか</strong>」（億円）です。<strong>同じ用途名が出ますが、出典も単位も別の統計で、足したり比べたりできません。</strong></li>
